...
@main.route('/pitches/salespitches')
def sales():
    pitches = Pitch.get_pitches('sales')
    return render_template("sales.html", pitches=pitches)

@main.route('/pitches/socialpitches')
def social():
    pitches = Pitch.get_pitches('social')
    return render_template("social.html", pitches=pitches)

@main.route('/pitches/conferencepitches')
def conference():
    pitches = Pitch.get_pitches('conference')
    return render_template("conference.html", pitches=pitches)
